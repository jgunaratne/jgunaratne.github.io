var allFields = [
                 drive.ds.Field.PARENTS,
                 drive.ds.Field.TITLE,
                 drive.ds.Field.MIME_TYPE,
                 drive.ds.Field.STARRED,
                 drive.ds.Field.HIDDEN,
                 drive.ds.Field.TRASHED,
                 drive.ds.Field.RESTRICTED,
                 drive.ds.Field.VIEWED,
                 drive.ds.Field.CREATE_DATE_MILLIS,
                 drive.ds.Field.MODIFIED_DATE_MILLIS,
                 drive.ds.Field.MODIFIED_BY_ME_DATE_MILLIS,
                 drive.ds.Field.LAST_VIEWED_BY_ME_DATE_MILLIS,
                 drive.ds.Field.FILE_SIZE,
                 drive.ds.Field.OWNERS,
                 drive.ds.Field.LAST_MODIFYING_USER,
                 drive.ds.Field.OPEN_URL,
                 drive.ds.Field.THUMBNAIL_URL,
                 drive.ds.Field.ICON_URL,
                 drive.ds.Field.ID,
                 drive.ds.Field.SHARED,
                 drive.ds.Field.SHARED_WITH_ME_DATE_MILLIS,
                 drive.ds.Field.DESCRIPTION,
                 drive.ds.Field.USER_ROLE,
                 drive.ds.Field.EXPLICITLY_TRASHED,
                 drive.ds.Field.IMAGE_DATE_MILLIS,
                 drive.ds.Field.IMAGE_WIDTH,
                 drive.ds.Field.IMAGE_HEIGHT,
                 drive.ds.Field.QUOTA_BYTES_USED,
                 drive.ds.Field.SHAREABLE,
                 drive.ds.Field.COPYABLE,
                 drive.ds.Field.SUBSCRIBED,
                 drive.ds.Field.HAS_CHILD_FOLDER,
                 drive.ds.Field.VISIBILITIES,
                 drive.ds.Field.DOWNLOADABLE,
                 drive.ds.Field.DOWNLOAD_URL,
                 drive.ds.Field.CREATOR_APP,
                 drive.ds.Field.FILE_EXTENSION,
                 drive.ds.Field.PRIMARY_SYNC_PARENT
               ];
...
DataHandler.prototype.retrieveFolderContents = function(folder) {
	...
	liveListListener.listen(liveList, drive.ds.ItemQueryLiveList.EventType.CHANGED, getAllItems);
...
DataHandler.prototype.updateFolderContents = function(folder, items) {
	...
	$('#itemCount').text(obj.fileCount + ' items cached.');
};